  ...
  return (
    <>
      <header className="sticky top-0 z-40 border-b border-line bg-ivory/90 backdrop-blur">
        <div className="mx-auto flex h-[112px] max-w-content items-center justify-between px-5 sm:px-8">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 top-[112px] z-40 flex flex-col justify-between bg-ivory p-8 lg:hidden">
